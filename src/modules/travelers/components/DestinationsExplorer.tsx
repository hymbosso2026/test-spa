...
const DESTINATIONS: Destination[] = [
  {
    ...
    name: 'Kribi',
    country: 'Cameroun',
    image: 'https://source.unsplash.com/1200x800/?kribi,cameroon',
  ...
  },
  {
    ...
    name: 'Mont Cameroun',
    country: 'Cameroun',
    image: 'https://source.unsplash.com/1200x800/?mount%20cameroon',
  ...
  },
  {
    ...
    country: 'Cameroun',
    image: 'https://source.unsplash.com/1200x800/?waza,cameroon',
  ...
  },
  {
    ...
    name: 'Yaounde',
    country: 'Cameroun',
    image: 'https://source.unsplash.com/1200x800/?yaounde,cameroon',
  ...
  },
  {
    ...
    name: 'Douala',
    country: 'Cameroun',
    image: 'https://source.unsplash.com/1200x800/?douala,cameroon',
    video: 'https://videos.pexels.com/video-files/4314358/4314358-uhd_2560_1440_25fps.mp4',
  ...
  },
  {
    ...
    name: 'Limbe',
    country: 'Cameroun',
    image: 'https://source.unsplash.com/1200x800/?limbe,cameroon',
    video: 'https://videos.pexels.com/video-files/3737181/3737181-uhd_2560_1440_25fps.mp4',
    description: 'Limbe offre des plages pretes pour la detente, des jardins botaniques luxuriants et une vue dominante sur l\'océan Atlantique.',
    highlights: ['Jardin botanique', 'Plages Noires', 'Mont Cameroun', 'Cuisine locale'],
    bestTime: 'Novembre - Avril',
    temperature: '24-30°C',
    rating: 4.9,
    reviews: 3450,
  ...
  },
  {
    ...
    name: 'Foumban',
    country: 'Cameroun',
    image: 'https://source.unsplash.com/1200x800/?foumban,cameroon',
    video: 'https://videos.pexels.com/video-files/3611699/3611699-uhd_2560_1440_25fps.mp4',
    description: 'Foumban est le coeur artistique du Cameroun, connu pour son palais royal et ses traditions d\'artisanat vivantes.',
    highlights: ['Palais royal', 'Marché artisanal', 'Musée des Rois Bamouns', 'Cérémonies culturelles'],
    bestTime: 'Décembre - Mars',
    temperature: '22-28°C',
    rating: 4.8,
    reviews: 2890,
    price: '€€€',
    duration: '4-6 jours',
    liked: false,
    tags: ['culture', 'historique', 'cameroun'],
  },
  {
    id: '8',
    name: 'Dschang',
    country: 'Cameroun',
    image: 'https://source.unsplash.com/1200x800/?dschang,cameroon',
    video: 'https://videos.pexels.com/video-files/2040005/2040005-uhd_2560_1440_25fps.mp4',
    description: 'Dschang est une ville de montagne connue pour son cadre frais, ses plantations de café et ses marchés animés.',
    highlights: ['Plantations de café', 'Forêts de la Menoua', 'Marché local', 'Randonnées'],
    ...
    duration: '3-5 jours',
    liked: false,
    tags: ['aventure', 'nature', 'cameroun'],
  },
  {
    id: '9',
    name: 'Bamenda',
    country: 'Cameroun',
    image: 'https://source.unsplash.com/1200x800/?bamenda,cameroon',
    video: 'https://videos.pexels.com/video-files/4314358/4314358-uhd_2560_1440_25fps.mp4',
    description: 'Bamenda propose des paysages de montagnes, des villages traditionnels et une culture riche du Nord-Ouest Cameroun.',
    highlights: ['Plateau des Bamboutos', 'Village Nso', 'Festivals locaux', 'Vue panoramique'],
    bestTime: 'Décembre - Mars',
    temperature: '18-24°C',
    rating: 4.7,
    reviews: 4100,
    ...
    duration: '4-6 jours',
    liked: false,
    tags: ['montagne', 'culture', 'cameroun'],
  },
  {
    id: '10',
    name: 'Korup',
    country: 'Cameroun',
    image: 'https://source.unsplash.com/1200x800/?korup,cameroon',
    video: 'https://videos.pexels.com/video-files/855940/855940-uhd_2560_1440_25fps.mp4',
    description: 'Le parc national de Korup est un sanctuaire de biodiversité, avec des forêts anciennes et une faune rare.',
    highlights: ['Randonnée en forêt', 'Observation de la faune', 'Cascades', 'Village Baka'],
    bestTime: 'Novembre - Avril',
    temperature: '22-28°C',
    rating: 4.8,
    reviews: 5600,
    ...
    duration: '5-8 jours',
    liked: false,
    tags: ['nature', 'safari', 'cameroun'],
  },
  {
    id: '11',
    name: 'Lac Ossa',
    country: 'Cameroun',
    image: 'https://source.unsplash.com/1200x800/?lake,cameroon',
    video: 'https://videos.pexels.com/video-files/3576378/3576378-uhd_2560_1440_25fps.mp4',
    description: 'Lac Ossa est un refuge tranquille, ideal pour les promenades en bateau et l\'observation des oiseaux.',
    highlights: ['Balades en bateau', 'Observation oiseaux', 'Plages douces', 'Nature sauvage'],
    ...
    duration: '2-4 jours',
    liked: false,
    tags: ['nature', 'plage', 'cameroun'],
  },
  {
    id: '12',
    name: 'Chutes de la Lobée',
    country: 'Cameroun',
    image: 'https://source.unsplash.com/1200x800/?waterfall,cameroon',
    video: 'https://videos.pexels.com/video-files/854720/854720-uhd_2560_1440_25fps.mp4',
    description: 'Les chutes de la Lobée offrent une experience visuelle magique avec de l\'eau qui se jette dans l\'océan depuis les falaises.',
    highlights: ['Cascade', 'Plage', 'Ambiance tropicale', 'Photographie'],
    bestTime: 'Novembre - Avril',
    temperature: '25-30°C',
    rating: 4.8,
    reviews: 6200,
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#007A5E]/5 via-white to-[#FCD116]/5">
      ...
      <div className="relative h-[70vh] min-h-[500px] overflow-hidden">
        <video
          ...
          poster="https://source.unsplash.com/1920x1080/?kribi,cameroon"
        >
